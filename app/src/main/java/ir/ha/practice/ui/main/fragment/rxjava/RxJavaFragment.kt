package ir.ha.practice.ui.main.fragment.rxjava
...
import ir.ha.practice.databinding.FragmentRxJavaContainerBinding
...
class RxJavaFragment : BaseFragment<FragmentRxJavaContainerBinding>() {
    override val layoutId: Int get() = R.layout.fragment_rx_java_container

    private lateinit var compositeDisposable: CompositeDisposable
    private lateinit var disposable: Disposable // (دور ریختنی) It means something to throw away
    private var rxJavaOperatorsChips = arrayOf("just", "filter", "skip", "take", "takeLast", "map", "flatMap", "concatMap", "switchMap", "interval operator", "timer operator", "multi operators"/*, "defer", "create", "interval", "range", "repeat", "start", "timer", "buffer", "flatMap", "GroupBy", "map", "scan"*/)
