package ir.ha.practice.ui.tabs.samples_tab
...
import ir.ha.practice.ui.tabs.samples_tab.animations.AnimationsFragment
import ir.ha.practice.ui.tabs.samples_tab.broadcast_eventbus.BroadcastReceiverFragment
import ir.ha.practice.ui.tabs.samples_tab.broadcast_eventbus.EventBusFragment
import ir.ha.practice.ui.tabs.samples_tab.db.RoomDBFragment
import ir.ha.practice.ui.tabs.samples_tab.db.pref.DataStoreFragment
import ir.ha.practice.ui.tabs.samples_tab.db.pref.SharedPreferencesFragment
import ir.ha.practice.ui.tabs.samples_tab.firebase.FirebaseCloudMessagingFrg
import ir.ha.practice.ui.tabs.samples_tab.flow.FlowFragment
import ir.ha.practice.ui.tabs.samples_tab.fragment_types.MyFragments
import ir.ha.practice.ui.tabs.samples_tab.loadimage.LoadImagesFragment
import ir.ha.practice.ui.tabs.samples_tab.material.MaterialDesignFragment
import ir.ha.practice.ui.tabs.samples_tab.mediaplayer.MediaPlayerFragment
import ir.ha.practice.ui.tabs.samples_tab.mediaplayer.VideoPlayerFragment
import ir.ha.practice.ui.tabs.samples_tab.mvvm_arch.MvvmContainerFragment
import ir.ha.practice.ui.tabs.samples_tab.mvvm_rx.MvvmRxFragment
import ir.ha.practice.ui.tabs.samples_tab.notification.NotificationFragment
import ir.ha.practice.ui.tabs.samples_tab.recyclerview.RecyclerViewFragment
import ir.ha.practice.ui.tabs.samples_tab.retrofit.RetrofitFragment
import ir.ha.practice.ui.tabs.samples_tab.rxjava.RxJavaFragment
import ir.ha.practice.ui.tabs.samples_tab.services.ServicesFragment
import ir.ha.practice.ui.tabs.samples_tab.thread.MultiThreadingClass
import ir.ha.practice.ui.tabs.samples_tab.thread.MyRunnableThread
import ir.ha.practice.ui.tabs.samples_tab.viewPager.ViewPagerFragment
    ...
    override fun onClick(v: View?) {
        ...
        when(v?.id){
            ...
            R.id.bannerSliderBtn ->{
                ...
                addFragmentByAnimation(
                    ViewPagerFragment(),"BannerSliderTag",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
                    commitAllowingStateLoss = false
            ...
            R.id.materialDesign -> {
                ...
                addFragmentByAnimation(
                    MaterialDesignFragment(),"ToolbarFrgSample",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
                    commitAllowingStateLoss = false)
            ...
            R.id.lottieAnimationView -> {
                ...
                addFragmentByAnimation(
                    AnimationsFragment(),"AnimationsFrg",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
            ...
            R.id.retrofitOkHttpBtn -> {
                ...
                addFragmentByAnimation(
                    RetrofitFragment(),"RequestFrgSample",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
                    commitAllowingStateLoss = false)
            ...
            R.id.btn_rxJava -> {
                ...
                addFragmentByAnimation(
                    RxJavaFragment(),"RxJavaContainer",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
                    commitAllowingStateLoss = false)
...
//                requireActivity().startActivity(Intent(this, HostActivity::class.java))
            }
            ...
            R.id.btn_MVVM -> {
                ...
                addFragmentByAnimation(
                    MvvmContainerFragment(),"MvvmContainerFrg",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
                    commitAllowingStateLoss = false)
            ...
            R.id.btn_firbase -> {
                ...
                addFragmentByAnimation(
                    FirebaseCloudMessagingFrg(),"FirebaseFrg",
                    addToBackStack = true,
                    customAnimations = true,
                    containerViewId = R.id.mainFrame,
                    commitAllowingStateLoss = false)
...
//                startActivity(Intent(this@MainActivity, BottomNavigationActivity::class.java))
            ...
            R.id.multiThreadingBtn -> {
                ...
                showToast(this@SamplesFragment.requireContext(),"output in Logcat..")
