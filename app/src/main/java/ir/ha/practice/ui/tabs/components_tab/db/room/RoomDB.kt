package ir.ha.practice.ui.tabs.components_tab.db.room

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import ir.ha.practice.ui.tabs.components_tab.db.room.entity.User


@Database(
    entities = [User::class], version = 4, exportSchema = false)
